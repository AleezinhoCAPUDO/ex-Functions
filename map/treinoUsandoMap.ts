...
console.log("Os números ao cubo ficam:", numerosAoCubo, "já os números divididos pela metade ficam:", numerosDivididos, "e os númemros vezes 19 ficam:", numerosMultiplicados  );